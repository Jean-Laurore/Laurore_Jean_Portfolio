...
namespace LauroreJean_FinalProject
{
    public class Helicopter:Vehicle
    {
        ...
        public Helicopter(string make, string model, string year, double loanAmount, int loanTerms, double estimatedAPR) : base(make, model, year, loanAmount, loanTerms, estimatedAPR)
        {
        ...
        public override void Delete()
        {
            ...
            Console.WriteLine("\nYou have deleted your helicopter from the list.");
